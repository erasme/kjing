...
Core.Util.include(appBase+'kjing/resourceitemview.js');
Core.Util.include(appBase+'kjing/groupitemview.js');
Core.Util.include(appBase+'kjing/groupuseritemview.js');
Core.Util.include(appBase+'kjing/folderitemview.js');
Core.Util.include(appBase+'kjing/mapitemview.js');
Core.Util.include(appBase+'kjing/useritemview.js');
Core.Util.include(appBase+'kjing/linkitemview.js');
...
Core.Util.include(appBase+'kjing/resourceview.js');
