...
Ui.Dialog.extend('Storage.TextEditor', {
	...
	constructor: function(config) {
		...
		if(navigator.isIE7 || navigator.isIE8)
			this.textField = new Ui.TextArea({ margin: 20, style: { "Ui.TextArea": { fontSize: 40, color: 'white' } } });
		else
			this.textField = new Ui.ContentEditable({ margin: 20, style: { "Ui.ContentEditable": { fontSize: 40, color: 'white' } } });
