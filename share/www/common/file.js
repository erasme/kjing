...
Core.Object.extend('KJing.File', {
	...
	update: function() {
		if(this.request != undefined)
			return;
		var url = '/cloud/storage/'+this.storage+'/'+this.file+"?depth="+this.depth;
	...
	create: function(id, depth) {
		...
		if(typeof(id) === 'string') {
			...
			return new KJing.File({ share: KJing.Resource.create(share), id: id, depth: depth });
		}
